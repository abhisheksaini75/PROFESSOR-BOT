...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("Cʜᴀɴɴᴇʟ 🔈", url="https://t.me/Movies_Telegram_Files")
            ],[      
            InlineKeyboardButton("Hᴇʟᴩ 🕸️", callback_data="help"),
            InlineKeyboardButton("Aʙᴏᴜᴛ ✨", callback_data="about")
        ]]
        m = await message.reply_sticker("CAACAgIAAxkBAAECsEZmRsXYHZcF81KXywN-uZqE6YQpBgACqwEAAhAabSJ4vr6RzFRsxzUE") 
        await asyncio.sleep(2)
